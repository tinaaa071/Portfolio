          ...
          <div class="inline-flex items-center space-x-3.5 group">
            ...
            <RouterLink to="/" class="">
              ...
              <div :class="showMenu ? 'text-white dark:text-stone-900' : 'text-stone-900 dark:text-white'" class="flex items-center gap-3 group">
                ...
                <h1 :class="showMenu ? 'text-white dark:text-stone-900' : 'text-stone-900 dark:text-white'" class="hidden text-xl font-medium transition-colors duration-300 xs:block group-hover:text-stone-500">
                  <SlideText />
                </h1>
              </div>
            </RouterLink>
        ...
        <div v-if="showMenu" class="z-20 flex flex-col justify-between p-2.5 md:p-5 whitespace-nowrap">
          <ul class="flex flex-col gap-2 text-sm font-semibold">
            ...
            <li class="flex gap-2">
              <!-- Resume -->
              <RouterLink to="/" 
              class=" py-2.5 bg-stone-50 border-2 border-white dark:border-stone-900 text-stone-800 rounded-full w-full hover:bg-Tertiary/80 transition-colors ease-in-out duration-300 dark:hover:bg-stone-800/50 dark:hover:text-white text-center">
                {{ $t('nav.item5') }}
              </RouterLink>
              <!-- Language -->
