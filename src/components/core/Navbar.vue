          ...
          <div class="inline-flex items-center space-x-3.5 group">
            ...
            <RouterLink to="/" class="">
              ...
              <div :class="showMenu ? 'text-white dark:text-stone-900' : 'text-stone-900 dark:text-white'" class="flex items-center gap-3 group">
                ...
                <h1 :class="showMenu ? 'text-white dark:text-stone-900' : 'text-stone-900 dark:text-white'" class="hidden text-xl font-medium transition-colors duration-300 xs:block group-hover:text-stone-400">
                  <SlideText />
                </h1>
              </div>
            </RouterLink>
