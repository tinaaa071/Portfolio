<template>
    <pre ref="codeContainer" class="w-full whitespace-pre-wrap xs:max-h-40 sm:max-h-64 aspect-square sm:rounded-3xl rounded-2xl max-h-32"><code ref="code" class="block overflow-hidden language-javascript" :style="{ fontSize: fontSize }">{{ displayedText }}</code></pre>
  </template>
