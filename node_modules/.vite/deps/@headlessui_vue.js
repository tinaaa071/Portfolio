...
function P(e4, r3, { sorted: t8 = true, relativeTo: l4 = null, skipElements: o6 = [] } = {}) {
  ...
  do {
    if (a5 >= d8 || a5 + d8 <= 0) return 0;
    let s7 = p3 + a5;
    if (r3 & 16) s7 = (s7 + d8) % d8;
    else {
      if (s7 < 0) return 3;
      if (s7 >= d8) return 1;
    }
...
function w3(f4, m5, l4 = computed(() => true)) {
  function a5(e4, r3) {
    if (!l4.value || e4.defaultPrevented) return;
    let t8 = r3(e4);
    ...
    for (let o6 of c5) {
      ...
      if (n6 != null && n6.contains(t8) || e4.composed && e4.composedPath().includes(n6)) return;
    }
...
function A({ visible: r3 = true, features: t8 = 0, ourProps: e4, theirProps: o6, ...i7 }) {
  ...
  if (r3 || t8 & 2 && n6.static) return y2(l4);
  if (t8 & 1) {
...
function y2({ props: r3, attrs: t8, slots: e4, slot: o6, name: i7 }) {
  ...
  if (o6) {
    let u8 = false, c5 = [];
    for (let [p3, f4] of Object.entries(o6)) typeof f4 == "boolean" && (u8 = true), f4 === true && c5.push(p3);
  ...
  if (n6 === "template") {
    if (a5 = b(a5 != null ? a5 : []), Object.keys(l4).length > 0 || Object.keys(t8).length > 0) {
      ...
      if (!v2(u8) || c5.length > 0) throw new Error(['Passing props on "template"!', "", `The current component <${i7} /> is rendering a "template".`, "However we need to passthrough the following props:", Object.keys(l4).concat(Object.keys(t8)).map((s7) => s7.trim()).filter((s7, g4, R3) => R3.indexOf(s7) === g4).sort((s7, g4) => s7.localeCompare(g4)).map((s7) => `  - ${s7}`).join(`
...
`));
      ...
      for (let s7 in p3) s7.startsWith("on") && (f4.props || (f4.props = {}), f4.props[s7] = p3[s7]);
      return f4;
    }
...
function j(...r3) {
  ...
  let t8 = {}, e4 = {};
  for (let i7 of r3) for (let n6 in i7) n6.startsWith("on") && typeof i7[n6] == "function" ? ((o6 = e4[n6]) != null || (e4[n6] = []), e4[n6].push(i7[n6])) : t8[n6] = i7[n6];
  if (t8.disabled || t8["aria-disabled"]) return Object.assign(t8, Object.fromEntries(Object.keys(e4).map((i7) => [i7, void 0])));
  for (let i7 in e4) Object.assign(t8, { [i7](n6, ...l4) {
    let a5 = e4[i7];
    for (let d8 of a5) {
...
function T2(r3, t8 = []) {
  ...
  for (let o6 of t8) o6 in e4 && delete e4[o6];
  return e4;
}
function v2(r3) {
...
function f2(l4, n6) {
  ...
  switch (l4.focus) {
    case 0: {
      for (let e4 = 0; e4 < t8.length; ++e4) if (!n6.resolveDisabled(t8[e4], e4, t8)) return e4;
      return r3;
    }
    case 1: {
      s7 === -1 && (s7 = t8.length);
      for (let e4 = s7 - 1; e4 >= 0; --e4) if (!n6.resolveDisabled(t8[e4], e4, t8)) return e4;
      return r3;
    }
    case 2: {
      for (let e4 = s7 + 1; e4 < t8.length; ++e4) if (!n6.resolveDisabled(t8[e4], e4, t8)) return e4;
      return r3;
    }
    case 3: {
      for (let e4 = t8.length - 1; e4 >= 0; --e4) if (!n6.resolveDisabled(t8[e4], e4, t8)) return e4;
      return r3;
    }
    case 4: {
      for (let e4 = 0; e4 < t8.length; ++e4) if (n6.resolveId(t8[e4], e4, t8) === l4.id) return e4;
      return r3;
    }
    case 5:
      return null;
...
function o3() {
  let a5 = [], s7 = { addEventListener(e4, t8, r3, i7) {
    ...
    return a5.push(e4), () => {
      ...
      if (t8 >= 0) for (let r3 of a5.splice(t8, 1)) r3();
    };
  }, dispose() {
    for (let e4 of a5.splice(0)) e4();
  } };
  return s7;
}
...
function e2(i7 = {}, s7 = null, t8 = []) {
  for (let [r3, n6] of Object.entries(i7)) o4(t8, f3(s7, r3), n6);
  return t8;
}
function f3(i7, s7) {
  return i7 ? i7 + "[" + s7 + "]" : s7;
...
function o4(i7, s7, t8) {
  if (Array.isArray(t8)) for (let [r3, n6] of t8.entries()) o4(i7, f3(s7, r3.toString()), n6);
  else t8 instanceof Date ? i7.push([s7, t8.toISOString()]) : typeof t8 == "boolean" ? i7.push([s7, t8 ? "1" : "0"]) : typeof t8 == "string" ? i7.push([s7, t8]) : typeof t8 == "number" ? i7.push([s7, `${t8}`]) : t8 == null ? i7.push([s7, ""]) : e2(t8, s7, i7);
}
function p(i7) {
  var t8, r3;
  let s7 = (t8 = i7 == null ? void 0 : i7.form) != null ? t8 : i7.closest("form");
  if (s7) {
    for (let n6 of s7.elements) if (n6 !== i7 && (n6.tagName === "INPUT" && n6.type === "submit" || n6.tagName === "BUTTON" && n6.type === "submit" || n6.nodeName === "INPUT" && n6.type === "image")) {
      n6.click();
      return;
    }
...
var Ze = defineComponent({ name: "Combobox", emits: { "update:modelValue": (a5) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], nullable: true, default: null }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, nullable: { type: Boolean, default: false }, multiple: { type: [Boolean], default: false }, immediate: { type: [Boolean], default: false }, virtual: { type: Object, default: null } }, inheritAttrs: false, setup(a5, { slots: I3, attrs: r3, emit: O5 }) {
  ...
  let n6 = { comboboxState: t8, value: v4, mode: M, compare(l4, i7) {
    ...
    h3.value = false, c5 !== null && cancelAnimationFrame(c5), c5 = requestAnimationFrame(() => {
      if (a5.disabled || d8.value && !g4.value.static && t8.value === 1) return;
      if (n6.virtual.value) {
    ...
    if (n6.activeOptionIndex.value !== null) {
      if (n6.virtual.value) C2(n6.virtual.value.options[n6.activeOptionIndex.value]);
      else {
  ...
  return onMounted(() => {
    watch([D], () => {
      if (!D.value || a5.defaultValue === void 0) return;
      function l4() {
  ...
  function R3(d8) {
    switch (d8.key) {
      ...
      case o2.ArrowUp:
        ...
        return;
      case o2.Escape:
        if (t8.comboboxState.value !== 0) return;
...
var ot = defineComponent({ name: "ComboboxInput", props: { as: { type: [Object, String], default: "input" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, displayValue: { type: Function }, defaultValue: { type: String, default: void 0 }, id: { type: String, default: () => `headlessui-combobox-input-${t()}` } }, emits: { change: (a5) => true }, setup(a5, { emit: I3, attrs: r3, slots: O5, expose: t8 }) {
  ...
  onMounted(() => {
    watch([g4, e4.comboboxState, R3], ([o6, v4], [c5, P2]) => {
      ...
      C2 && ((P2 === 0 && v4 === 1 || o6 !== c5) && (C2.value = o6), requestAnimationFrame(() => {
        var D;
        if (u8.value || !C2 || ((D = R3.value) == null ? void 0 : D.activeElement) !== C2) return;
  ...
  function h3(o6) {
    switch (u8.value = true, o6.key) {
      case o2.Enter:
        if (u8.value = false, e4.comboboxState.value !== 0 || S5.value) return;
      ...
      case o2.PageDown:
        return u8.value = false, o6.preventDefault(), o6.stopPropagation(), e4.goToOption(c3.Last);
      case o2.Escape:
        if (u8.value = false, e4.comboboxState.value !== 0) return;
  ...
  function M(o6) {
    ...
    if (u8.value = false, !((P2 = o(e4.optionsRef)) != null && P2.contains(v4)) && !((C2 = o(e4.buttonRef)) != null && C2.contains(v4)) && e4.comboboxState.value === 0) return o6.preventDefault(), e4.mode.value === 0 && (e4.nullable.value && e4.value.value === null ? d8() : e4.activationTrigger.value !== 1 && e4.selectActiveOption()), e4.closeCombobox();
  }
  function K(o6) {
    var c5, P2, C2;
    let v4 = (c5 = o6.relatedTarget) != null ? c5 : t5.find((V3) => V3 !== o6.currentTarget);
...
var at = defineComponent({ name: "ComboboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, order: { type: [Number], default: null } }, setup(a5, { slots: I3, attrs: r3, expose: O5 }) {
  ...
  function m5(p3) {
    var o6;
    if (a5.disabled || (o6 = t8.virtual.value) != null && o6.disabled(a5.value)) return p3.preventDefault();
  ...
  function w5() {
    var o6;
    if (a5.disabled || (o6 = t8.virtual.value) != null && o6.disabled(a5.value)) return t8.goToOption(c3.Nothing);
  ...
  function M(p3) {
    var v4;
    if (!h3.wasMoved(p3) || a5.disabled || (v4 = t8.virtual.value) != null && v4.disabled(a5.value) || u8.value) return;
...
function z({ ownerDocument: t8, container: n6, initialFocus: r3 }, l4) {
  ...
  return onMounted(() => i7.value = true), onUnmounted(() => i7.value = false), onMounted(() => {
    watch([n6, r3, l4], (e4, m5) => {
      if (e4.every((a5, s7) => (m5 == null ? void 0 : m5[s7]) === a5) || !l4.value) return;
      let f4 = o(n6);
      f4 && t6(() => {
        var F3, H3;
        if (!i7.value) return;
...
function N4(t8, n6) {
  for (let r3 of t8) if (r3.contains(n6)) return true;
  return false;
}
  ...
  return t2() ? { before({ doc: r3, d: n6, meta: c5 }) {
    ...
    n6.microTask(() => {
      ...
      n6.addEventListener(r3, "click", (t8) => {
        ...
        if (t8.target instanceof HTMLElement) if (o6(t8.target)) {
          let e4 = t8.target;
          for (; e4.parentElement && o6(e4.parentElement); ) e4 = e4.parentElement;
...
function m2(e4) {
  let n6 = {};
  for (let t8 of e4) Object.assign(n6, t8(n6));
  return n6;
}
...
a2.subscribe(() => {
  ...
  for (let [t8] of e4) n6.set(t8, t8.documentElement.style.overflow);
...
function E4(d8, f4 = ref(true)) {
  watchEffect((o6) => {
    ...
    o6(function() {
      ...
      if (r3 === 1 ? t7.delete(e4) : t7.set(e4, r3 - 1), r3 !== 1) return;
      let n6 = i6.get(e4);
...
function N5({ defaultContainers: o6 = [], portals: i7, mainTreeNodeRef: H3 } = {}) {
  ...
  function u8() {
    var l4, f4, a5;
    let n6 = [];
    for (let e4 of o6) e4 !== null && (e4 instanceof HTMLElement ? n6.push(e4) : "value" in e4 && e4.value instanceof HTMLElement && n6.push(e4.value));
    if (i7 != null && i7.value) for (let e4 of i7.value) n6.push(e4);
    for (let e4 of (l4 = r3 == null ? void 0 : r3.querySelectorAll("html > *, body > *")) != null ? l4 : []) e4 !== document.body && e4 !== document.head && e4 instanceof HTMLElement && e4.id !== "headlessui-portal-root" && (e4.contains(o(t8)) || e4.contains((a5 = (f4 = o(t8)) == null ? void 0 : f4.getRootNode()) == null ? void 0 : a5.host) || n6.some((M) => e4.contains(M)) || n6.push(e4));
    return n6;
  }
...
var _2 = defineComponent({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(r3, { slots: e4, attrs: u8 }) {
  ...
  return watch(t8, () => {
    ...
    if (!d8.value || o6.value === null) return null;
...
var _e = defineComponent({ name: "Dialog", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, open: { type: [Boolean, String], default: I2 }, initialFocus: { type: Object, default: null }, id: { type: String, default: () => `headlessui-dialog-${t()}` }, role: { type: String, default: "dialog" } }, emits: { close: (t8) => true }, setup(t8, { emit: n6, attrs: l4, slots: u8, expose: i7 }) {
  ...
  if (i7({ el: c5, $el: c5 }), !(t8.open !== I2 || S5 !== null)) throw new Error("You forgot to provide an `open` prop to the `Dialog`.");
  if (typeof R3.value != "boolean") throw new Error(`You provided an \`open\` prop to the \`Dialog\`, but the value is not a boolean. Received: ${R3.value === I2 ? void 0 : t8.open}`);
  ...
  E4(le3, te2), R({ type: "Dialog", enabled: computed(() => f4.value === 0), element: c5, onUpdate: (e4, a5) => {
    if (a5 === "Dialog") return u(e4, { [s6.Add]: () => m5.value += 1, [s6.Remove]: () => m5.value -= 1 });
  } });
...
var We = defineComponent({ name: "DialogBackdrop", props: { as: { type: [Object, String], default: "div" }, id: { type: String, default: () => `headlessui-dialog-backdrop-${t()}` } }, inheritAttrs: false, setup(t8, { attrs: n6, slots: l4, expose: u8 }) {
  ...
  return u8({ el: r3, $el: r3 }), onMounted(() => {
    if (i7.panelRef.value === null) throw new Error("A <DialogBackdrop /> component is being used, but a <DialogPanel /> component is missing.");
  }), () => {
...
var Q = defineComponent({ name: "DisclosureButton", props: { as: { type: [Object, String], default: "button" }, disabled: { type: [Boolean], default: false }, id: { type: String, default: null } }, setup(t8, { attrs: r3, slots: o6, expose: s7 }) {
  ...
  function D(u8) {
    var S5;
    if (!t8.disabled) if (n6.value) switch (u8.key) {
      case o2.Space:
      case o2.Enter:
...
function o5(e4) {
  ...
  let u8 = false;
  for (let f4 of t8.querySelectorAll('[hidden],[aria-hidden],[role="img"]')) f4.remove(), u8 = true;
...
function p2(a5) {
  ...
  return () => {
    ...
    if (!e4) return "";
    let l4 = e4.innerText;
    if (t8.value === l4) return r3.value;
...
var Ie = defineComponent({ name: "Listbox", emits: { "update:modelValue": (t8) => true }, props: { as: { type: [Object, String], default: "template" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => pe }, horizontal: { type: [Boolean], default: false }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, multiple: { type: [Boolean], default: false } }, inheritAttrs: false, setup(t8, { slots: c5, attrs: l4, emit: L3 }) {
  ...
  let y4 = computed(() => t8.multiple ? 1 : 0), [h3, V3] = d(computed(() => t8.modelValue), (a5) => L3("update:modelValue", a5), computed(() => t8.defaultValue)), M = computed(() => h3.value === void 0 ? u(y4.value, { [1]: [], [0]: void 0 }) : h3.value), r3 = { listboxState: e4, value: M, mode: y4, compare(a5, n6) {
    ...
    if (t8.disabled || e4.value === 1) return;
  ...
  return onMounted(() => {
    watch([m5], () => {
      if (!m5.value || t8.defaultValue === void 0) return;
      function a5() {
...
var Fe = defineComponent({ name: "ListboxOption", props: { as: { type: [Object, String], default: "li" }, value: { type: [Object, String, Number, Boolean] }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-listbox.option-${t()}` } }, setup(t8, { slots: c5, attrs: l4, expose: L3 }) {
  ...
  function T5(r3) {
    if (t8.disabled) return r3.preventDefault();
  ...
  function D() {
    if (t8.disabled) return e4.goToOption(c3.Nothing);
    e4.goToOption(c3.Specific, t8.id);
  }
  let y4 = u3();
  function h3(r3) {
...
var be3 = defineComponent({ name: "MenuItem", inheritAttrs: false, props: { as: { type: [Object, String], default: "template" }, disabled: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-menu-item-${t()}` } }, setup(r3, { slots: b3, attrs: l4, expose: I3 }) {
  ...
  function t8() {
    if (r3.disabled) return e4.goToItem(c3.Nothing);
...
var ye = defineComponent({ name: "Popover", inheritAttrs: false, props: { as: { type: [Object, String], default: "div" } }, setup(P2, { slots: b3, attrs: p3, expose: h3 }) {
  ...
  let e4 = ref(1), c5 = ref(null), d8 = ref(null), O5 = ref(null), f4 = ref(null), y4 = computed(() => i2(t8)), M = computed(() => {
    var Y2, Z2;
    if (!o(c5) || !o(f4)) return false;
    for (let B2 of document.querySelectorAll("body > *")) if (Number(B2 == null ? void 0 : B2.contains(o(c5))) ^ Number(B2 == null ? void 0 : B2.contains(o(f4)))) return true;
  ...
  function m5(n6) {
    ...
    if (f4.value) {
      ...
      case o2.Enter:
        ...
        break;
      case o2.Escape:
        if (t8.popoverState.value !== 0) return d8 == null ? void 0 : d8(t8.buttonId.value);
        if (!o(t8.button) || (g4 = e4.value) != null && g4.activeElement && !((E6 = o(t8.button)) != null && E6.contains(e4.value.activeElement))) return;
...
var je2 = defineComponent({ name: "PopoverPanel", props: { as: { type: [Object, String], default: "div" }, static: { type: Boolean, default: false }, unmount: { type: Boolean, default: true }, focus: { type: Boolean, default: false }, id: { type: String, default: () => `headlessui-popover-panel-${t()}` } }, inheritAttrs: false, setup(P2, { attrs: b3, slots: p3, expose: h3 }) {
  ...
  h3({ el: e4.panel, $el: e4.panel }), onMounted(() => {
    ...
    var u8, i7;
    if (!t8 || e4.popoverState.value !== 0 || !e4.panel) return;
  ...
  function M(s7) {
    ...
    switch (s7.key) {
      case o2.Escape:
        if (e4.popoverState.value !== 0 || !o(e4.panel) || c5.value && !((u8 = o(e4.panel)) != null && u8.contains(c5.value.activeElement))) return;
  ...
  function I3() {
    ...
    function u8() {
      u(m5.value, { [d3.Forwards]: () => {
        ...
        for (let N9 of E6.slice()) if (N9.dataset.headlessuiFocusGuard === "true" || n6 != null && n6.contains(N9)) {
          let $4 = E6.indexOf(N9);
          $4 !== -1 && E6.splice($4, 1);
        }
...
var ge3 = defineComponent({ name: "RadioGroup", emits: { "update:modelValue": (t8) => true }, props: { as: { type: [Object, String], default: "div" }, disabled: { type: [Boolean], default: false }, by: { type: [String, Function], default: () => re2 }, modelValue: { type: [Object, String, Number, Boolean], default: void 0 }, defaultValue: { type: [Object, String, Number, Boolean], default: void 0 }, form: { type: String, optional: true }, name: { type: String, optional: true }, id: { type: String, default: () => `headlessui-radiogroup-${t()}` } }, inheritAttrs: false, setup(t8, { emit: c5, attrs: u8, slots: E6, expose: d8 }) {
  ...
  let [f4, S5] = d(computed(() => t8.modelValue), (e4) => c5("update:modelValue", e4), computed(() => t8.defaultValue)), p3 = { options: i7, value: f4, disabled: computed(() => t8.disabled), firstOption: computed(() => i7.value.find((e4) => !e4.propsRef.disabled)), containsCheckedOption: computed(() => i7.value.some((e4) => p3.compare(toRaw(e4.propsRef.value), toRaw(t8.modelValue)))), compare(e4, a5) {
    ...
    var n6;
    if (t8.disabled || p3.compare(toRaw(f4.value), toRaw(e4))) return false;
  ...
  function m5(e4) {
    if (!s7.value || !s7.value.contains(e4.target)) return;
  ...
  return onMounted(() => {
    watch([v4], () => {
      if (!v4.value || t8.defaultValue === void 0) return;
      function e4() {
...
var me2 = defineComponent({ name: "TabGroup", emits: { change: (a5) => true }, props: { as: { type: [Object, String], default: "template" }, selectedIndex: { type: [Number], default: null }, defaultIndex: { type: [Number], default: 0 }, vertical: { type: [Boolean], default: false }, manual: { type: [Boolean], default: false } }, inheritAttrs: false, setup(a5, { slots: v4, attrs: i7, emit: s7 }) {
  ...
  let r3 = { selectedIndex: computed(() => {
    ...
    var f4;
    if (n6.value.includes(t8)) return;
  ...
  return onMounted(() => {
    ...
    if (!h3.value || b3.value == null || r3.tabs.value.length <= 0) return;
    ...
    return h(Fragment, [n6.value.length <= 0 && h(d6, { onFocus: () => {
      for (let e4 of n6.value) {
        let u8 = o(e4);
        if ((u8 == null ? void 0 : u8.tabIndex) === 0) return u8.focus(), true;
      }
      return false;
...
function l3(r3) {
  let e4 = { called: false };
  return (...t8) => {
    if (!e4.called) return e4.called = true, r3(...t8);
  };
}
...
var he2 = defineComponent({ props: { as: { type: [Object, String], default: "div" }, show: { type: [Boolean], default: null }, unmount: { type: [Boolean], default: true }, appear: { type: [Boolean], default: false }, enter: { type: [String], default: "" }, enterFrom: { type: [String], default: "" }, enterTo: { type: [String], default: "" }, entered: { type: [String], default: "" }, leave: { type: [String], default: "" }, leaveFrom: { type: [String], default: "" }, leaveTo: { type: [String], default: "" } }, emits: { beforeEnter: () => true, afterEnter: () => true, beforeLeave: () => true, afterLeave: () => true }, setup(e4, { emit: t8, attrs: a5, slots: s7, expose: h3 }) {
  ...
  if (!me3() && s4()) return () => h(Se3, { ...e4, onBeforeEnter: r3, onAfterEnter: l4, onBeforeLeave: f4, onAfterLeave: S5 }, s7);
